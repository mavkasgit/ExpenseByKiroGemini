...
import { getGoogleSignInURL, getGoogleForceSelectURL } from '@/lib/actions/auth'
    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <div className="text-center text-sm">
          ...
          >
            Использовать другой аккаунт Google
          </button>
        </div>
