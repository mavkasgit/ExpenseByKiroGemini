      ...
      `}>
        <div className="py-2">
          ...
          <button
            ...
            className={`
              flex items-center w-full px-4 py-2 text-sm transition-all duration-200 rounded-md mx-2
              ${isSigningOut 
                ? 'text-gray-400 cursor-not-allowed bg-gray-50' 
                : 'text-red-600 hover:bg-red-50 hover:text-red-700 hover:shadow-sm transform hover:scale-[1.02]'
              }
            `}
          >
            {isSigningOut ? (
              ...
              <>
                <svg className="w-4 h-4 mr-3 transition-transform duration-200 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
